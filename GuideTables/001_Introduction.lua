...
Table_001_Introduction = {
    [0001] = {
        ...
        items = {
            ...
            [14] = { str = "#HUNTER Спецефические задания охотника.#" },
            [15] = { str = "#PICTURE Нужно исследовать.#" },
            [16] = { str = "#COORDS Квестовые объекты/мобы/итемы.#" },
            [17] = { str = "#ACCEPTBINDABLE KEYS:#  Переключение шагов гайда вперед или назад можно настроить в меню назначения клавиш." },
            [18] = { str = "." },
            --[19] = { str = "." },
            --[20] = { str = "." },
        }
