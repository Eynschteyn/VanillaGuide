...
-----------32-32 Stranglethorn Vale
	...
	[3232] = {
		...
		items = {
			...
			[7] = { str = "7. #HUNTERИдите в точку 29,8 на запад от лагеря Nessingway’s и приручите Stranglethorn Tiger и изучите навк Dash Rank 1. Используйте этого питомца пока не доберетесь до Booty Bay#", x = 29, y = 8, zone = "Stranglethorn Vale"},
