...
-----------32-33 Thousand Needles (Shimmering Flats)
	...
	[3233] = {
		...
		items = {
			...
			[2] = { str = "1. Now Get the FP on the west side of this zone at 8,18, it’s just inside Feralas. This will save a lot of time later on.", x = 8, y = 18, zone = "Thousand Needles" },
			[3] = { str = "2. You should be close to level 33 so grind to it on your way to Shimmering Flats." },
			[4] = { str = "3. Go to 78,77 and turn in  #TURNINThe Brassbolts Brothers#  accept  #ACCEPTHardened Shells#  and  #ACCEPTSalt Flat Venom#", x = 78, y = 77, zone = "Thousand Needles" },
			[5] = { str = "4. Go a little beside these guys and grab  #ACCEPTRocket Car Parts#,  #ACCEPTWharfmaster Dizzywig#  and  #ACCEPTHemet Nesingwary#" },
			[6] = { str = "5. Go east to 80,75 and accept  #ACCEPTLoad Lightening#", x = 80, y = 75, zone = "Thousand Needles" },
			[7] = { str = "6. Go to 81,77 and accept  #ACCEPTA Bump in the Road#", x = 81, y = 77, zone = "Thousand Needles" },
			[8] = { str = "7. Now the car parts for  #DOQUESTRocket Car Parts#  are scattered all over here, so grab them as you quest. The Buzzards for  #DOQUESTLoad Lightening#  are all over as well so kill one if you see it." },
			[9] = { str = "8. Start off by going south and killing gazers and crystalhide at 76,87 for  #DOQUESTA Bump in the Road#", x = 76, y = 87, zone = "Thousand Needles" },
			[10] = { str = "9. Kill scorpions at 71,74 and north of here for  #DOQUESTSalt Flat Venom#", x = 71, y = 74, zone = "Thousand Needles" },
			[11] = { str = "10. Kill Basilisks around 73,59 for  #DOQUESTA Bump in the Road#", x = 73, y = 59, zone = "Thousand Needles" },
			[12] = { str = "11. Kill Turtles at 82,54 for  #DOQUESTHardened Shells#", x = 82, y = 54, zone = "Thousand Needles" },
			[13] = { str = "12. Stop at 86,66 and do  #DOQUESTLoad Lightening#", x = 86, y = 66, zone = "Thousand Needles" },
			[14] = { str = "13. Run back to 77,77 turn in  #TURNINRocket Car Parts#", x = 77, y = 77, zone = "Thousand Needles" },
			[15] = { str = "14. Go to the 2 npc’s next east of here and hand in  #TURNINSalt Flat Venom#  and  #TURNINHardened Shells#  then accept  #ACCEPTMartek the Exiled#" },
			[16] = { str = "15. Run east to 80,75 turn in  #TURNINLoad Lightening#  accept  #ACCEPTGoblin Sponsorship pt.1#", x = 80, y = 75, zone = "Thousand Needles" },
			[17] = { str = "16. Go to 81,77 and turn in  #TURNINA Bump in the Road#", x = 81, y = 77, zone = "Thousand Needles" },
			[18] = { str = "17. Run south into Tanaris and Grab the FP at Gadgetzan" },
			[19] = { str = "18. Hearth back to IF and fly to Menethil Harbor, get on the boat to Theramore, Get FP and either fly to Stonetalon Mountains or go back and sail to Darkshore." },
		}
	},
