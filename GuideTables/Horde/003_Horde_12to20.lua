...
-----------12-15 Barrens
	...
	[1215] = {
		...
		items = {
			...
			[22] = { str = "22. Once #DOQUEST\"Stolen Booty\"#  is completed hearth to Crossroads. (don't turn it in yet)" },
			...
			[26] = { str = "26. Run west from Crossroads, go to the guy in the hut... (at 45.28)", x = 45, y = 28, zone = "The Barrens" },
