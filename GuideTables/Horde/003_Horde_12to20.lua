...
-----------12-15 Barrens
	...
	[1215] = {
		...
		items = {
			...
			[2] = { str = "2. Turn in #TURNIN\"Conscript of the Horde\"# (62.19 in the Barrens) accept #ACCEPT\"Crossroads Conscription\"# ", x = 62, y = 19, zone = "The Barrens" },
			[3] = { str = "3. Then turn in #TURNIN\"Ak'Zeloth\"# (62.20) I SKIP \"#NPCThe Demon Seed\"# ", x = 62, y = 20, zone = "The Barrens" },
			[4] = { str = "4. Run to XRs (Crossroads) (at 52.30) #HUNTER (If you're a hunter do step 4)#", x = 52, y = 30, zone = "The Barrens" },
			[5] = { str = "#HUNTER5. While on my way to XRs, I  abandon my crab and tame a Savannah Huntress cat, for my new pet.#" },
			[6] = { str = "6. Once at XRs (at 52.30) turn in #TURNIN\"Crossroads Conscription\"# Then accept all quests in XRs (which includes: #ACCEPT\"Meats to Orgrimmar\"# #ACCEPT\"Plainstrider Menace\"#   #ACCEPT\"The Forgotten Pools\"# #ACCEPT\"Raptor Thieves\"# #ACCEPT\"Wharfmaster Dizzywig\"# #ACCEPT\"Fungal Spores\"# #ACCEPT\"Disrupt the Attacks\"# #ACCEPT\"Supplies for the Crossroads\"# and #ACCEPT\"Harpy Raiders\"# on top of the watch tower).  Turn in #TURNIN\"Meats to Orgrimmar\"# i SKIP \"#NPCRide to Orgrimmar\"# ", x = 52, y = 30, zone = "The Barrens" },
			[7] = { str = "7. Make XRs your home." },
			[8] = { str = "8. Get FP (Flight Path)" },
			[9] = { str = "9. Then go do:  #DOQUEST\"Disrupt the Attacks\"# along with #DOQUEST\"Plainstrider Menace\"# and #DOQUEST\"Raptor Thieves\"# (all around 54.26).  NOTE: If you find #ACCEPT\"Chen's Empty Keg\"# accept it.", x = 54, y = 26, zone = "The Barrens" },
