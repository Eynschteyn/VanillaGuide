...
-----------21-21 Ashenvale
	...
	[2121] = {
		...
		items = {
			...
			[2] = { str = "2. Run to Splintertree Post (at 73.65)", x = 73, y = 65, zone = "Ashenvale" },
			[3] = { str = "3. Turn in #TURNIN\"The Ashenvale Hunt\"# .  Then accept and turn in #TURNIN\"The Ashenvale Hunt\"# again." },
			[4] = { str = "4. Get FP in Splintertree Post." },
			[5] = { str = "5. Run all the way to Zoram Strand (at 13.31), grind mobs along the way.", x = 13, y = 31, zone = "Ashenvale" },
			[6] = { str = "6. Get FP there. (12.33).  Turn in #TURNIN\"Trouble in the Deeps\"# .. i SKIP \"#NPCThe Essence of Aku'Mai\"# ", x = 12, y = 33, zone = "Ashenvale" },
			[7] = { str = "7. Do the following quests:" },
			[8] = { str = "8. Accept and do #DOQUEST\"Naga at the Zoram Strand\"# then turn it in." },
			[9] = { str = "9. Hearth back to Crossroads, if hearth stone is still on a cooldown, fly there." },
			--[10] = { str = "." },
			--[11] = { str = "." },
		}
	},
...
-----------22-23 Southern Barrens
	...
	[2223] = {
		...
		items = {
			...
			[2] = { str = "2. Fly to CT." },
			[3] = { str = "3. Turn in #TURNIN\"Jorn Skyseer\"# ... accept #ACCEPT\"Ishamuhale\"# and #ACCEPT\"Melor Sends Word\"# " },
			[4] = { str = "4. Make CT your home." },
			[5] = { str = "5. I give bloodshards to the gnoll in the cage to get increased agility/spirit." },
			[6] = { str = "6. Run south and keep an eye out for the mob named #NPCOwatanka# (around 45.62), he drops 'Owatanka's Tailspike' which starts #ACCEPT\"Owatanka\"# ", x = 45, y = 62, zone = "The Barrens" },
			[7] = { str = "7. #DOQUEST\"Egg Hunt\"# (44.71)", x = 44, y = 71, zone = "The Barrens" },
			[8] = { str = "8. #DOQUEST\"Chen's Empty Keg\"# (if you have it)" },
			[9] = { str = "9. #DOQUEST\"Betrayal from Within\"# and #DOQUEST\"Weapons of Choice\"# (43.79)", x = 43, y = 79, zone = "The Barrens" },
			[10] = { str = "10. Accept #ACCEPT\"Gann's Reclamation\"# from #NPCGann Stonespire#.  Then go do it (at 46.86). Then turn it in, accept #ACCEPT\"Revenge of Gann\"# ", x = 46, y = 86, zone = "The Barrens" },
			[11] = { str = "11. Hearth back to Camp Taurajo, turn in #TURNIN\"Weapons of Choice\"# and #TURNIN\"Betrayal from Within\"# ... accept #ACCEPT\"Betrayal from Within\"# part2" },
			[12] = { str = "12. Fly to XR." },
			[13] = { str = "13. Turn in #TURNIN\"Betrayal from Within\"# part2 and #TURNIN\"Egg Hunt\"# " },
			[14] = { str = "14. Do #DOQUEST\"Ishamuhale\"# (at 60.32)", x = 60, y = 32, zone = "The Barrens" },
			[15] = { str = "15. Turn in #TURNIN\"Further Instructions\"# (at Ratchet 63.37) ... accept #ACCEPT\"Further Instructions\"# part2", x = 63, y = 37, zone = "The Barrens" },
			[16] = { str = "16. Turn in #TURNIN\"Deepmoss Spider Eggs\"# and #TURNIN\"Chen's Empty Keg\"# " },
			[17] = { str = "17 Fly to Stonetalon Mountains..." },
			--[18] = { str = "." },
			--[19] = { str = "." },
		}
	},
