...
-----------26-27 Ashenvale
	...
	[2627] = {
		...
		items = {
			...
			[15] = { str = "15. Возьмите и выполните задание #DOQUEST\"Vorsha the Lasher\"#. После выполнения этого задания вернитесь и сдайте его #HUNTERПОДСКАЗКА: НПС находится в домике слева если его нет то подождите он зареспится этот такое задание нужно идти с ним#" },
